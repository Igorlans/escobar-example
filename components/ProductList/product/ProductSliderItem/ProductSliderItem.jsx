...
const ProductSliderItem = ({product, setIsShow}) => {
    return (
        <>
            <div className={classes.product} onClick={product.description ? () => setIsShow(true) : null}>
                 {product.imageUrl
                    ? (
                        <div className={classes.product__img}>
                            <Image src={product.imageUrl} alt={product.title} width={300} height={300} quality={50}/>
                        </div>
                    )
